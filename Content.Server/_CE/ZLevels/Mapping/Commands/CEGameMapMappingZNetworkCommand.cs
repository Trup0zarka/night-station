...
public sealed class CEGameMapMappingZNetworkCommand : LocalizedEntityCommands
{
    ...
    public override CompletionResult GetCompletion(IConsoleShell shell, string[] args)
    {
        ...
        foreach (var map in _proto.EnumeratePrototypes<GameMapPrototype>())
        {
            ...
            {
                if (station.StationComponentOverrides.TryGetComponent("CEStationZLevels", out var zNetworkComp) && zNetworkComp is CEStationZLevelsComponent zNetwork)
                {
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        {
            if (station.StationComponentOverrides.TryGetComponent("CEStationZLevels", out var zNetComp) && zNetComp is CEStationZLevelsComponent zNet)
            {
                zNetwork = zNet;
                break;
            }
