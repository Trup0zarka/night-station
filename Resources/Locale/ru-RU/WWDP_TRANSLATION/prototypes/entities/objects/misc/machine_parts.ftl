...
ent-BluespaceMatterBinStockPart = вместительная ёмкость материи
    .desc = Контейнер, предназначенный для хранения экстра-спресованных материалов, ожидающих восстановления.
    .suffix = { "" }
