...
ent-ClothingBackpackDuffelHolding = вместительный вещмешок
    .desc = Вещмешок, имеющий особые растягиваемые скрытые карманы для хранения большого количества вещей.
    .suffix = { "" }
