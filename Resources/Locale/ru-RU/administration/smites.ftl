...
admin-smite-wanted-name = Объявить в розыск
admin-smite-cyberpsycho-name = Объявить киберпсихом
...
admin-smite-wanted-description = Объявляет цель в розыск NCPD. Уведомление придёт на все тактические планшеты, а принявший вызов офицер получит живой маркер.
admin-smite-cyberpsycho-description = Объявляет цель киберпсихом. Высший приоритет — уведомление с красным маркером на всех тактических планшетах NCPD.

## Night City — NCPD Dispatch Messages (sent to tablets)
admin-smite-wanted-dispatch-title = РОЗЫСК
admin-smite-wanted-dispatch-sector = Night City
admin-smite-wanted-dispatch-description = ВНИМАНИЕ: Подозреваемый { $name } объявлен в розыск. Задержать живым или мёртвым.

admin-smite-cyberpsycho-dispatch-title = CYBERPSYCHO ALERT
admin-smite-cyberpsycho-dispatch-sector = Night City
admin-smite-cyberpsycho-dispatch-description = ЭКСТРЕННЫЙ ВЫЗОВ: { $name } — подтверждённый киберпсихоз. Субъект крайне опасен. MaxTac рекомендован.
