...
reagent-name-artiplates = артипласт
reagent-desc-artiplates = Высокоэффективная форма искусственной крови, которая быстро расширяется при попадании в кровоток. Из-за своих расширяющих свойств она может вызывать серьезные внутренние кровотечения в больших дозах.

reagent-name-enunciase = энунициаз
reagent-desc-enunciase = Фермент, который помогает стимулировать языковые центры мозга, устраняя заикание, вызванное другими препаратами, и временно заставляя говорить "идеально". В больших дозах вызывает тошноту.
