...
wires-menu-help-popup =
    ...
    ВНИМАНИЕ: Перерезание проводов больше не вызывает срабатывание функций устройства (взлом). Для взаимодействия с логикой устройства используйте импульсы мультитула.
    
    Индикаторы в верхней части показывают состояние устройства.
