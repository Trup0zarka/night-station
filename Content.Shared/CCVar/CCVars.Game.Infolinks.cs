...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string> InfoLinksDiscord =
        CVarDef.Create("infolinks.discord", "https://discord.gg/rzBGucy4fu", CVar.SERVER | CVar.REPLICATED); // WD EDIT
    ...
    public static readonly CVarDef<string> InfoLinksGithub =
        CVarDef.Create("infolinks.github", "", CVar.SERVER | CVar.REPLICATED); // WD EDIT
